                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="my-3">
                                ...
                                <br><b style="color:brown">Jumlah: {{ format_rupiah($cart->property->price * $cart->quantity) }}</b>
                                <div class="row">
                                    <div class="col-md-1">
                                        <form class="mt-2">
                                            <a href="{{ route('customer.checkout.edit.quantity', ['cart' => $cart->id]) }}" class="btn btn-warning"><i class="fa fa-solid fa-pencil"></i></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('customer.checkout.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_payment_id" class="select-picker form-control @error('category_payment_id') is-invalid @enderror"  style="width:100%;" id="payment">>
                                ...
                                <option value="{{ $payment->id }}" {{ (old('category_payment_id') == $payment->id) ? "selected" : "" }}>
                                    {{ $payment->name }}
                                </option>
                                @endif
                                @endforeach
                        ...
                        <div class="form-group credit_period">
                            ...
                            <select name="credit_period" class="select-picker form-control @error('credit_period') is-invalid @enderror credit_period" id="credit_period"  style="width:100%;">
