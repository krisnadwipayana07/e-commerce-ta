...
<a href="javascript:;" onclick="show_hide_insert()" class="btn btn-sm btn-success">
...
Kategori Barang Data
@endsection

@section('page-content-desc')
Halaman Untuk mengatur kategori Barang data
@endsection
    ...
    <div class="col-12">
        <div id="insert-box">
            <div class="card mb-4 shadow-none">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.category_property.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
