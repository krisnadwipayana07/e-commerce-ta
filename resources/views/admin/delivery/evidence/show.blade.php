...
<div class="border-bottom py-3">
    <h6 class="font-weight-bold">Nomber Telepon</h6>{{ $transaction->account_number }}
</div>
<div class="border-bottom py-3">
...
<div class="my-5">
    ...
    <form action="{{ route('admin.delivery.evidence.store', $transaction->id) }}" method="POST"
        ...
        <div class="row mt-3">
            ...
            <div class="col-md">
                <div class="form-group">
                    <input type="file" class="form-control @error('product_evidence') is-invalid @enderror"
                        name="product_evidence" value="{{ old('product_evidence') }}" id="product_evidence" required>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md">
                <div class="form-group">
                    <input type="file" class="form-control @error('signature_evidence') is-invalid @enderror"
                        name="signature_evidence" value="{{ old('signature_evidence') }}" id="signature_evidence"
                        required>
