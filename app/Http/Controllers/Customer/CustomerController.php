...
class CustomerController extends Controller
{
    public function index(Request $request) {
        ...
        //                 return actionBtn('Customer', route('customer.customer.index'), route('customer.customer.show', $data->id), route('customer.customer.edit', $data->id), route('customer.customer.destroy', $data->id));
        //             })
        //             ->rawColumns(['action'])
        //             ->make(true);
        // }
        // return view('customer.customer.index');
        return redirect()->route('customer.customer.edit', auth()->guard('customer')->user()->id);
    }
    ...
    public function show(Customer $customer) {
        return view('customer.customer.show', ['data' => $customer]);
    }

    public function edit(Customer $customer) {
        return view('customer.customer.edit', ['data' => $customer]);
    }
