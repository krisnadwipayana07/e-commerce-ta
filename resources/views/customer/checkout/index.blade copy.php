                            ...
                            <div class="col-md-6">
                                <div class="my-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            <form class="mt-2">
                                                <a href="{{ route('customer.checkout.edit.quantity', ['cart' => $cart->id]) }}"
                    ...
                    <form action="{{ route('customer.checkout.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                @foreach ($payments as $payment)
                                    @if (
                                        ...
                                        <option value="{{ $payment->id }}"
                                            {{ old('category_payment_id') == $payment->id ? 'selected' : '' }}>
                                            {{ $payment->name }}
                                        </option>
                                    @endif
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select name="province"
                                class="select-picker form-control @error('province') is-invalid @enderror"
                                style="width:100%;" id="province">>
                                <option value="">--PILIH--</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="recipient_name" class="form-control"
                                value="{{ auth()->guard('customer')->user()->name }}" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <textarea name="ktp_address" id="ktp_address" cols="30" rows="10" placeholder="Jawaban Anda"
                                class="form-control credit_period_input"></textarea>
                        </div>
                        <div class="form-group credit_period">
                            <label for="nickname" class="form-label">Nama Panggilan</label>
                            <input type="text" class="form-control credit_period_input" name="nickname"
                                id="nickname" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="mother_name" class="form-label">Nama Ibu Kandung</label>
                            <input type="text" class="form-control credit_period_input" name="mother_name"
                                id="mother_name" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="post_code" class="form-label">Kode Pos</label>
                            <input type="number" class="form-control credit_period_input" name="post_code"
                                id="post_code" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="birth_place" class="form-label">Tempat Lahir</label>
                            <input type="text" class="form-control credit_period_input" name="birth_place"
                                id="birth_place" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="birth_date" class="form-label">Tanggal Lahir</label>
                            <input type="date" class="form-control credit_period_input w-25" name="birth_date"
                                id="birth_date">
                        </div>
                        <div class="form-group credit_period">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <input type="text" class="form-control credit_period_input" name="company_name"
                                id="company_name" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            ...
                            <textarea name="company_address" id="company_address" cols="30" rows="10"
                                class="form-control credit_period_input" placeholder="Jawaban Anda"></textarea>
                        </div>
                        <div class="form-group credit_period">
                            <label for="company_phone" class="form-label">No Telepon Perusahaan</label>
                            <input type="text" class="form-control credit_period_input" name="company_phone"
                                id="company_phone" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <input type="text" class="form-control credit_period_input" name="transportation_brand"
                                id="transportation_brand" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <input type="text" class="form-control credit_period_input" name="police_number"
                                id="police_number" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="transportation_color" class="form-label">Warna</label>
                            <input type="text" class="form-control credit_period_input" name="transportation_color"
                                id="transportation_color" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="bpkb_number" class="form-label">Nomor BPKB</label>
                            <input type="text" class="form-control credit_period_input" name="bpkb_number"
                                id="bpkb_number" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="rekening_number" class="form-label">Nomor Rekening</label>
                            <input type="text" class="form-control credit_period_input" name="rekening_number"
                                id="rekening_number" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <input type="text" class="form-control credit_period_input" name="owner_rekening"
                                id="owner_rekening" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                            <label for="house_image" class="form-label">Foto Rumah</label>
                            <input type="file" class="form-control credit_period_input" name="house_image"
                                id="house_image">
                        </div>
                        <div class="form-group credit_period">
                            <label for="ktp" class="form-label">Foto KTP</label>
                            <input type="file" class="form-control credit_period_input" name="ktp"
                                id="ktp">
                        </div>
                        <div class="form-group credit_period">
                            <label for="photo" class="form-label">Foto Selfie</label>
                            <input type="file" class="form-control credit_period_input" name="photo"
                                id="photo">
                        </div>
                        <div class="form-group credit_period">
                            <label for="salary_slip" class="form-label">Foto Slip Gaji</label>
                            <input type="file" class="form-control credit_period_input" name="salary_slip"
                                id="salary_slip">
                        </div>
                        <div class="form-group credit_period">
                            <label for="transportation_image" class="form-label">Foto Kendaraan</label>
                            <input type="file" class="form-control credit_period_input" name="transportation_image"
                                id="transportation_image">
                        </div>
                        <div class="form-group credit_period">
                            <label for="rekening_book_image" class="form-label">Foto Buku Rekening</label>
                            <input type="file" class="form-control credit_period_input" name="rekening_book_image"
                                id="rekening_book_image">
                        </div>
                        <div class="form-group credit_period">
                            <label>Periode Kredit</label>
                            <select name="credit_period"
                                class="select-picker form-control credit_period_input @error('credit_period') is-invalid @enderror credit_period"
                                id="credit_period" style="width:100%;">
                        ...
                        <div class="total_show">
                            <p class="fw-bold">Ongkos Kirim : {{IDRConvert($delivery_fee)}} </p>
                            <p class="fw-bold">Total : {{IDRConvert($total)}} </p>
                        </div>
...
@section('page-js')
    <script>
        ...
        $('#province').on('change', function () {
            ...
            totalShow = "<p class='fw-bold'> Ongkos Kirim : "+ delivery_fee +" </p>"
            totalShow += "<p class='fw-bold'> Total : "+ n_total +" </p>"
