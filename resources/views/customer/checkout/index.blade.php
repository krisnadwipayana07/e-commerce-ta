    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 margin_top40">
                ...
                <div class="col-md-2">
                    <img src="{{ asset('upload/admin/property/' . $cart->property->img) }}" alt="{{ asset($cart->property->name) }}" />
                </div>
                <div class="col-md-6">
                    <div class="my-3">
                        @php
    ...
    <div class="row">
        <form action="{{ route('customer.checkout.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div id="map" class="my-3 @error('name') border border-danger @enderror" style="height: 280px;">
                </div>
