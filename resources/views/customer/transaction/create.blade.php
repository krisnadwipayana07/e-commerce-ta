...
@section('page-back-button')
    <a href="{{ route('customer.transaction.index') }}" class="my-2 btn btn-secondary btn-sm"><i class="ri-arrow-left-circle-line"></i> Back</a>
@endsection
        ...
        <div class="col-12">
            <div>
                <div class="card mb-4 shadow-none">
                    <div class="card-body">
                        <form method="POST" action="{{ route('customer.transaction.store') }}" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('POST')
                            <div class="row gx-5">
                                <div class="col-md-8">
