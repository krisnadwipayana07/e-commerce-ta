...
@section('content')
    <div class="container">
        <div class="d-flex align-items-center my-3">
            ...
            <div class="gap-5">
                <a href="{{ route('customer.notification.transaction.index') }}"
                    class="btn btn-{{ request()->get('filter') === null ? 'primary' : 'outline-primary' }} rounded-pill ml-1">Semua</a>
                <a href="{{ route('customer.notification.transaction.index', ['filter' => 'payment']) }}"
                ...
                <a href="{{ route('customer.notification.transaction.index', ['filter' => 'in_transit']) }}"
                    ...
                    Pengiriman</a>
                <a href="{{ route('customer.notification.transaction.index', ['filter' => 'delivered']) }}"
                    class="btn btn-{{ request()->get('filter') === 'delivered' ? 'primary' : 'outline-primary' }} rounded-pill ">Sampai
                    Ditujan</a>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <form>
                                        <fieldset disabled>
                                            ...
                                            @if ($transaction['isTransfer'])
                                                <div class="mb-3">
                                                    <label for="disabledTextInput" class="form-label">Batas Waktu
                                                        Pembayaran</label>
                                                    <input type="text" id="disabledTextInput" class="form-control"
                                            ...
                                            @if ($transaction['isCredit'])
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="disabledTextInput" class="form-control"
                                                        value="{{ $transaction['credit_period'] }}">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="disabledTextInput" class="form-label">Pembayaran Per
                                                        Bulan</label>
                                                    <input type="text" id="disabledTextInput" class="form-control"
                                                        value="{{ $transaction['credit_payment'] }}">
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="disabledTextInput" class="form-label">Sisa
                                                                Pembayaran</label>
                                                            <input type="text" id="disabledTextInput"
                                                                class="form-control"
                                                                value="{{ $transaction['remaining_payment'] }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="disabledTextInput"
                                                                class="form-control"
                                                                value="{{ $transaction['remaining_instalment'] }}x">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @if ($transaction['isCOD'] && $transaction['delivery'] == 'Diterima')
                                        <div>
                                            <button type="button"
                                                class="btn btn-success text-white btn-block text-uppercase"
                                                style=" font-weight: 600"> SUDAH DIKIRIM </button>
                                        </div>
                                    @else
                                        <div>
                                            <button type="button"
                            ...
                            @if ($transaction['isCredit'] && $transaction['remaining_instalment'] > 0)
                                <div class="row mt-2">
                                    @if ($transaction['isDP'])
                                        @if ($transaction['latestPayment'] === 'pending')
                                            <div class="col-md-4 mt-1"></div>
                                            <div class="col-md-8 mt-1">
                                                <a href="javascript:;"
                                                    onclick="penuliskode_modal('Pembayaran Kredit', '{{ $transaction['route'] }}')"
                                        ...
                                        @else
                                            ...
                                            <div class="col-md-8 mt-1">
                                                <a href="javascript:;"
                                                    onclick="penuliskode_modal('Pembayaran Kredit', '{{ $transaction['route'] }}')"
                                                    class="btn btn-block btn-success ">Bayar
                                                    Cicilan</a>
                                            </div>
                                        @endif
                                    @else
                                        ...
                                        @elseif ($transaction['statuses'] != 'reject')
                                            ...
                                            <div class="col-md-8 pb-1">
                                                <a href="{{ route('customer.notification.transaction.edit', $transaction['id']) }}"
                                                    class="btn btn-block btn-secondary">UBAH DATA</a>
                                            </div>
                                        @endif
                                    @endif
                                </div>
