<form method="POST" action="{{ route('customer.dp.payment.store', $transaction->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="border-bottom py-3">
        <h6 class="font-weight-bold">Code</h6>{{ $transaction->code }}
    </div>
    <div class="border-bottom py-3">
        <h6 class="font-weight-bold">Down Payment</h6>{{ format_rupiah($transaction->down_payment) }}
    </div>
    <div class="row mb-3">
        <div class="col-md">
            <div class="form-group">
            <label>Evidence Credit Payment</label>
