...
@section('page-back-button')
    <a href="{{ route('customer.customer.index') }}" class="my-2 btn btn-secondary btn-sm"><i class="ri-arrow-left-circle-line"></i> Back</a>
@endsection
...
@section('page-desc')
    Page to edit customer data
@endsection

@section('page-content-body')
<div class="row">
    <div class="col-md">
        <form method="POST" action="{{ route('customer.customer.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-md">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-12 my-2">
                    <img id="preview-myimg" src="{{ ($data->img) ? url('/upload/admin/customer/', $data->img) : 'https://cdn.pixabay.com/photo/2015/12/22/04/00/photo-1103595_960_720.png' }}" alt="preview image" style="height: 300px;">
                </div>
            </div>
