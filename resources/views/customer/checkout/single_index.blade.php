...
@section('content')
    <div class="news">
        <div class="container">
                        ...
                        <div class="col-md-6">
                            <div class="my-3">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <form class="mt-2">
                                            <a href="{{ route('customer.checkout.single.edit.quantity', ['property_id' => $property->id, 'quantity' => $quantity]) }}"
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('customer.checkout.single.store') }}" method="POST"
                        ...
                        <div class="form-group credit_period">
                            ...
                            <input type="number" class="form-control credit_period_input" name="ktp_number"
                                id="ktp_number" placeholder="Jawaban Anda">
                        </div>
                        <div class="form-group credit_period">
                        ...
                        <div class="form-group credit_period">
                            ...
                            <select name="credit_period" id="credit_period"
